...
Comparing treatment groups/timepoints. **Note:** The DEGs were called with "data"
as the assay, but the expression values were not normalized and the analysis was
thus done on the raw counts (?), yielding more DEGs.
