...
seurat_data <- readRDS("/scratch/hnatri/CART/PD1_mm_Seurat_GSEA.Rds")
...
colnames(sig_res_myeloid_celltype) <- c(colnames(sig_res_myeloid_celltype)[1:6],
                                                as.character(sig_res_myeloid_celltype[nrow(sig_res_myeloid_celltype),][7:ncol(sig_res_myeloid_celltype)]))
